...
class Aluno(models.Model):
    ...
    naturalidade = models.ForeignKey(UnidadeFederativa, on_delete=models.CASCADE, null=True, blank=True, verbose_name="Naturalidade:")
    nacionalidade = models.CharField(max_length=100, null=True, blank=True, verbose_name="Nacionalidade:")
    dt_nascimento = models.DateField()
    estado_civil = models.ForeignKey(EstadoCivil, on_delete=models.CASCADE, null=True, blank=True, verbose_name="Estado civil:")
    ...
    sexo = models.ForeignKey(Sexo, on_delete=models.CASCADE, null=True, blank=True, verbose_name="Sexo:")
    email = models.EmailField(null=True, blank=True, verbose_name="Email:")
    etnia = models.ForeignKey(Etnia, on_delete=models.CASCADE, blank=True, null=True, verbose_name="Raça/Etnia:")
    ...
    cadastrado_por = models.ForeignKey(User, on_delete=models.CASCADE, related_name='aluno_cadastrado_por')
